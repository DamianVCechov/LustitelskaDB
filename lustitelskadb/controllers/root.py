...
class RootController(BaseController):
    ...
    def _default(self, game=None, *args, **kw):
        ...
        for lg in game_nums:
            ...
            if lg.game_no % 7 == 5:
                game = game.order_by(model.GameResult.game_result_time == None, model.GameResult.wednesday_challenge.desc(), model.GameResult.game_result_time, model.GameResult.game_rows, model.GameResult.game_time.desc())
            else:
                game = game.order_by(model.GameResult.game_result_time == None, model.GameResult.game_result_time, model.GameResult.game_rows, model.GameResult.game_time.desc())
